...
import (
	...
	accountdao "github.com/leeseika/cv-demo/biz/design/proj-structure/layer/legacy/dao/account"
...
type (
	Account interface {
		...
		GetAccountByID(ctx context.Context, id string) (*dto.AccountInfo, error)
